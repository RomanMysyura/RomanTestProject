...
<template>
    <div class="navbar bg-gray-200">
        ...
        <div class="navbar-end">
            <Link href="/" class="btn btn-ghost btn-circle">
            <svg width="31px" height="31px" viewBox="0 -0.5 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <Link href="/profile" class="btn btn-ghost btn-circle">
            <div class="indicator">
